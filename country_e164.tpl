{*
 * e.164 country list from Smart Messaging Platform
 *
...
{if isset($filter_sadc) && true === $filter_sadc}
        ...
        <option value="DO">Dominican Republic (+18)</option>
        ...
        <option value="WW">International</option>
        <option value="IR">Iran (+98)</option>
        <option value="IQ">Iraq (+964)</option>
        <option value="IE">Ireland (+353)</option>
        <option value="IM">Isle of Man</option>
        <option value="IL">Israel (+972)</option><option value="IT">Italy (+39)</option>
        <option value="CI">Ivory Coast (+225)</option><option value="JM">Jamaica (+1876)</option>
...
{if isset($filter_sadc) && true === $filter_sadc}
        ...
        <option value="RE">Réunion Island (+262)</option>
...
{if isset($filter_sadc) && true === $filter_sadc}
        ...
        <option value="VA">Vatican City (+3)</option>
